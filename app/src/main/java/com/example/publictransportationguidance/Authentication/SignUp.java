...
public class SignUp extends AppCompatActivity {
    ...
    private void performAuth() {
        ...
        if(!email.matches(emailPattern)){ binding.em.setError("Enter correct Email"); }
        else if(password.isEmpty()||password.length()<6){ binding.pass.setError("Enter correct password"); }
        else{
